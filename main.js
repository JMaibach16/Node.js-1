...
const material10 = new THREE.MeshBasicMaterial( {color: "grey", side: THREE.DoubleSide} );
...
bouncingSave = bouncingSave.filter((element) => element !== clickedThing.object.name);
}, 80)
}
